...
**Amendment 2026-07-18 — review findings fixed.** The 2026-07-17 review (`docs/decisions/_review-2026-07-17.md`) found six verified Criticals; all are fixed and pinned by the test suite (`test/*.test.mjs`, `npm test`):
