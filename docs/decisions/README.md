...
- [11 — Loud stall over silent recovery](11-loud-stall-over-silent-recovery.md) — writes to the non-regenerable overlays serialize behind a lock that never displaces a holder it cannot prove dead, and stop with a self-describing error rather than recovering automatically. An age-based lock steal was built, measured to trade a loud failure for a silent one, and removed.
